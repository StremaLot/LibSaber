...
namespace LibSaber.QuakeChampions.Serialization
{
  ...
  public class pctPICTURESerializer : QCSerializerBase<pctPICTURE>
  {
    ...
    private void ReadFormat(NativeReader reader, pctPICTURE pict)
    {
      ...
      var format = (QCTextureFormat)formatValue;

      ASSERT(Enum.IsDefined(typeof(QCTextureFormat), format),
